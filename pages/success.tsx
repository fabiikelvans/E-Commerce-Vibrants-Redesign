    ...
    return (
        <div>
            ...
            <main className='grid grid-cols-1 lg:grid-cols-9'>
                <section className='order-2 mx-auto lg:col-span-5 max-w-xl pb-12 lg:mx-0 lg:max-w-none lg:pr-16
                lg:pt-12 xl:pl-16 2xl:pl-44'>
                    <Link href='/'>
                    ...
                    <div className='mx-4 my-4 lg:ml-14'>
                        <div>
                            {/*Slice returns the last 5 charaters of the string*/}
                ...
                {mounted && (
                    ...
                    bg-gradient-to-br from-blue-50 to-pink-50 lg:order-2 lg:col-span-4 lg:h-screen lg:border-y-0 scrollbar-hide' >
                        ...
                        {showOrderSummaryCondition && (
                            <div className='mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 px-2 lg:mx-0
                            lg:max-w-lg lg:px-10 lg:py-16'>
                                <div className='space-y-4 py-4 overflow-y-scroll h-[55vh] scrollbar-hide'>
                                    {products.map((product) => (
                                        ...
                                        >
                                            ...
                                            <p className='flex-1 font-medium'>{product.description}</p>
                                ...
                                <div className='space-y-1 py-4 mt-2'>
